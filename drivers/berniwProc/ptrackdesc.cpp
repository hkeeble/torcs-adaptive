/*
	...
	Desc: Definitions file for a class that holds a track description for the robot. This is a modified version of the original berniw robot for TORCS Adaptive.
*/
...
PTrackDesc::PTrackDesc(const tTrack* track)
{
	...
	if (currentts != nTrackSegments) printf("error: PTrackDesc::PTrackDesc currentts %d != nTrackSegments %d.\n", currentts, nTrackSegments);
