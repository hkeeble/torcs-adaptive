...
{
	pSegFactory* ProceduralTrackManager::segFactory = pSegFactory::GetInstance();

	void ProceduralTrackManager::Init(tCarElt* car, tRmInfo* RaceManager, pTrack* Track, pSegFactory* SegFactory)
	{
	...
	void ProceduralTrackManager::AddSegment(tRmInfo* ReInfo, const pSeg& segment)
	{
	...
	void ProceduralTrackManager::UpdateACFile(tRmInfo* ReInfo, pTrack* trInfo)
	{
	...
	void ProceduralTrackManager::UpdateTrack(tRmInfo* ReInfo)
	{
		bool updateAC = false;
		pTrack* trInfo;
